...
constexpr const char* PIPE_NAME = R"(\\.\pipe\VH_TextureServer)";
...
constexpr uint64_t SHM_DATA_WINDOW_SIZE = static_cast<uint64_t>(SLOTS_PER_WINDOW) * SLOT_TOTAL;
...
inline auto HashPath(const char* path) -> uint64_t {
